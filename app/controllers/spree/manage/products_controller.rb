module Spree
  ...
  def product_params
    params.require(:product).permit(:name, :description, master_attributes: [:sku, :price, :lead_time, :id, prices_attributes: [:id, :amount]],
      variants_attributes: [:sku, :price, :lead_time, :id, prices_attributes: [:id, :amount]])
  end
